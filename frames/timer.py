...
class Timer(ttk.Frame):
    def __init__(self, parent, controller, show_settings):
        ...
        self.current_time_label = tk.StringVar(value=controller.timer_scheduled[0])
        ...
        timer_frame.grid(row=1, column=0, columnspan=2, pady=(10, 10), sticky="NESW")
    ...
    def reset_timer(self):
        ...
        self.controller.timer_scheduled = deque(self.controller.timer_order)
        self.current_time_label.set(self.controller.timer_scheduled[0])
    ...
    def decrement_time(self):
        ...
        if self.timer_running and current_time != "00:00":
            ...
            self.controller.timer_scheduled.rotate(-1)
            next_up = self.controller.timer_scheduled[0]
